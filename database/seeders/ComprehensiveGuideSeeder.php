...
class ComprehensiveGuideSeeder extends Seeder
{
    ...
    {
        // Clear existing guides and steps
        Step::truncate();
        Guide::truncate();
        ...
        // 2. Creator Campaign Application Guide
        ...
        // 3. Creator Content Creation Guide
        ...
        // 4. Creator Chat Communication Guide
